...
#         raise HTTPException(
#             status_code=403,
#             detail="Only Seekers can use this endpoint"
#     )
...
#         - Treat synonyms and related terms as the same skill.
#         (e.g., Authorization = role-based access, Passport.js, RBAC)
#         - A skill is considered MISSING only if there is NO explicit
#         OR implicit evidence in the resume.
#         - Do NOT list the same skill in both matched and missing.

#         SCORING RULES:
#         - Required skills in JD have higher weight than "Nice to have".
#         - Missing required skills reduce score more than missing nice-to-have skills.
#         - Experience gap (required years vs actual years) must reduce the score.
#         - Final score must be realistic and justified.
...
#     except Exception as e:
#         raise HTTPException(500, f"AI JSON parse failed: {str(e)}")
